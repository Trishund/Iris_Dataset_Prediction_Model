...
with st.sidebar.form("predict_form"):
    sl = st.slider('Sepal Length (cm)', float(df.sepal_length.min()), float(df.sepal_length.max()), float(df.sepal_length.mean()), 0.01)
    sw = st.slider('Sepal Width (cm)', float(df.sepal_width.min()), float(df.sepal_width.max()), float(df.sepal_width.mean()), 0.01)
    pl = st.slider('Petal Length (cm)', float(df.petal_length.min()), float(df.petal_length.max()), float(df.petal_length.mean()), 0.01)
    pw = st.slider('Petal Width (cm)', float(df.petal_width.min()), float(df.petal_width.max()), float(df.petal_width.mean()), 0.01)
